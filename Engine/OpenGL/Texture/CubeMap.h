...
namespace StarEngine
{
	...
	public:
		...
		inline VOID SetWrapR(TextureWrap const WrapR) { _WrapR = WrapR; }
	...
	public:
		...
		VOID UpdateBuffer(VOID const* Buffer, BOOL const GenerateMipMaps, U32 const Index);
	...
	private:
		...
		TextureWrap _WrapR = TEXTURE_WRAP_NONE;
